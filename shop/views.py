...
def orders_details(request,pk):
    if request.user.is_authenticated:
        ...
        messages.success(request,'دسترسی امکان ندارد')
...
def login_user(request):
    if request.method == "POST":
        ...
        if user is not None:
            ...
            messages.success(request, ("movafagh"))
            return redirect("home")
        else:
            messages.success(request, ("namovafagh"))
...
def logout_user(request):
    logout(request)
    messages.success(request, ('kharej shodi'))
    return redirect ("home")
...
def signup_user (request):
    ...
    if request.method=="POST":
        ...
        if form.is_valid():
            ...
            login(request, user)
            messages.success(request, ("ثبت  موفق"))
            return redirect("update_info")
        else:
            messages.success(request, ("ثبت نام  نا موفق"))
...
def update_password(request):
    if request.user.is_authenticated:
        ...
        messages.success(request,'لاگین شوید')
        return redirect('home')
...
def category(request, cat):
    ...
    try:
        ...
        return redirect("home")
        messages.success(request, ("نا موفق"))
